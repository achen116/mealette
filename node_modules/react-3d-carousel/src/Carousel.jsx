            ...
            return (<figure key={i} style={Util.figureStyle(d)}>
               <div className="ui card">
                 ...
                 <div className="content">
                   ...
                   <div className="meta">
                   <span className="closed">{d.card.hash.is_closed ? "Closed Now" : "Open Now"}</span>
                   </div>
        ...
        return (
          <div>
            ...
            <div className='spin-button'>
              <button className='massive ui button' onClick={Util.partial(this.onRotate,-((Math.floor(Math.random() * (39 - 19 + 1)) + 19)*angle))}>Spin</button>
            </div>
          </div>
        );
    }
