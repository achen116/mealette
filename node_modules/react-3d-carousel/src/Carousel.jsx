            ...
            return (<figure key={i} style={Util.figureStyle(d)}>
               <div className="ui card">
                 ...
                 <div className="extra content">
                   <span>
                    <i className="red star icon"></i>{d.card.hash.rating}
                   </span>
                   <span className="card-category">{d.card.hash.categories[0][0]}</span>
                   <span className="right floated">
                     <a href={"https://maps.google.com/maps?q="+d.card.hash.location.display_address[0] + " " + d.card.hash.location.display_address[1] } target="_blank"><i className="red map icon"></i>{d.card.hash.location.display_address[0]}</a>
                   </span>
                 </div>
               </div>
               </figure>);
        ...
        return (
          <div>
            ...
            <div className='spin-button'>
              <button className='massive ui red button' onClick={Util.partial(this.onRotate,-((Math.floor(Math.random() * (39 - 19 + 1)) + 19)*angle))}>
                <i className="refresh icon spinning-button"></i>
              </button>
            </div>
          </div>
        );
